// teboninBeratungstraining.js
const { sleep, clickUmfrageAnswer, clickUmfrageNextQuestionButton, writeUmfrageAnswer } = require("./utils");
...
async function teboninBeratungstraining(page) {
  try {
    ...
    console.error("Error in teboninBeratungstraining:", error);
    throw error; // Rethrow the error to be handled in the main script
  }
}

module.exports = {
    teboninBeratungstraining,
};